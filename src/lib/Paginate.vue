  ...
  <ul :class="containerClass" v-if="!noLiSurround">
    <li v-if="firstLastButton" :class="[pageClass, firstPageSelected() ? disabledClass : '']">
      <a
        ...
        :class="pageLinkClass" :tabindex="firstPageSelected() ? -1 : 0"
    ...
    <li v-if="!(firstPageSelected() && hidePrevNext)" :class="[prevClass, firstPageSelected() ? disabledClass : '']">
      <a
        ...
        v-html="prevText"></a>
      <a
        v-else @click="prevPage()"
        @keyup.enter="prevPage()"
        :class="[prevLinkClass, firstPageSelected() ? disabledClass : '']"
        tabindex="0"><slot name="prevContent">{{ prevText }}</slot></a>
    </li>
    ...
    <li
      ...
      <a
        ...
        :class="pageLinkClass"
        >
        <slot :name="page.content" :page="page">{{page.content}}</slot>
      </a>
    </li>
