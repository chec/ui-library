    ...
    {{
      ...
      template: `
        <div class="flex justify-center font-lato mx-auto p-16" :class="background">
          <ChecTab @click="active = 1" :round="round" :active="active === 1">Tab one</ChecTab>
          <ChecTab @click="active = 2" :round="round" :active="active === 2">Tab two</ChecTab>
          <ChecTab @click="active = 3" :round="round" disabled :active="active === 3">Tab three</ChecTab>
          <ChecTab @click="active = 4" :round="round" :active="active === 4">Tab four</ChecTab>
        </div>`
    }}
  </Story>
</Preview>
