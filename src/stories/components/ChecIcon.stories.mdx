...
<summary>
Todo list
- Add dashboard navigation icons once finalized
</summary>
</details>
...
- Navigation icons are used in the dashboard navigation bar. Default size is `w-6 h-6` for 24px

- Marketing icons are utilized on marketing site and product dashboard
