    ...
    {{
      ...
      template: `
        <div class="p-16 flex justify-center w-1/2 m-auto" :class="{'bg-gray-500': background === 'dark'}">
          <CodeBlock :grow="grow" :language="language" :editable="editable" :line-numbers="lineNumbers">// Render your payment form\n\nconst elements = stripe.elements();\n\nconst card = elements.create(1234);</CodeBlock>
        </div>`
    }}
  </Story>
</Preview>
  ...
  <Story name="Code Block Group">
    {{
      ...
      props: {
        ...
        showLogos: {
          default: boolean('Show logos', true),
        },
      },
      template: `
        <div class="p-16 flex justify-center w-1/2 m-auto" :class="{'bg-gray-500': background === 'dark'}">
          <CodeBlockGroup :show-logos="showLogos">
