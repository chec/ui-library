  ...
  <Story name="Defaults">
    {{
      ...
      props: {
        ...
        variant: {
          default: select('Variant', ['large', 'regular', 'round'], 'regular'),
        },
        disabled: {
      ...
      template: `
        <div class="py-16 flex justify-center">
          <base-button :color="color" :variant="variant" :icon-position="iconPosition" :disabled="disabled">
            {{text}}
...
<Preview>
  <Story name="States and sizes" decorators={[withKnobs()]}>
    {{
      ...
      template: `
        <div class="py-16 grid grid-cols-3 gap-4 justify-center mx-20">
